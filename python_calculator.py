...
#planned expansion and refractoring of IO operations
...
#label creation does a similar thing to button. we only take [text, row, column, command, columnspan, bg, fg and sticky]
...
def constants_values():
    ...
    maths_label.grid_configure(row=2,column=0,columnspan=6,sticky=W)
    maths_label_eulers_constant_e.grid_configure(row=4,column=0,columnspan=6,sticky=W)
    maths_label_eulers_constant_y.grid_configure(row=5,column=0,columnspan=6,sticky=W)
    maths_label_pi.grid_configure(row=6,column=0,columnspan=6,sticky=W)
    maths_label_golden_ratio.grid_configure(row=7,column=0,columnspan=6,sticky=W)
    maths_label_imaginary.grid_configure(row=8,column=0,columnspan=6,sticky=W)
    maths_label_Khinchins.grid_configure(row=9,column=0,columnspan=6,sticky=W)
    ...
    physics_label.grid_configure(row=2,column=8,columnspan=6, sticky=W)
    physics_label_newtons_constant_of_grav.grid_configure(row=4,column=8,columnspan=6, sticky=W)
    physics_label_planks_constant.grid_configure(row=5,column=8,columnspan=6, sticky=W)
    physics_label_avogadro_constant.grid_configure(row=6,column=8,columnspan=6, sticky=W)
